...
import com.yunzia.hyperstar.ui.component.dialog.SuperXPopupUtil.Companion.ShowXDialog
...
fun SuperXDialog(
    ...
    title: String? = null,
    titleColor: Color = SuperXDialogDefaults.titleColor(),
    summary: String? = null,
    summaryColor: Color = SuperXDialogDefaults.summaryColor(),
    backgroundColor: Color = SuperXDialogDefaults.backgroundColor(),
    onFocus: () -> Unit = {},
    onDismissRequest: (() -> Unit)? = null,
    outsideMargin: DpSize = SuperXDialogDefaults.outsideMargin,
    insideMargin: DpSize = SuperXDialogDefaults.insideMargin,
    defaultWindowInsetsPadding: Boolean = true,
    content: @Composable () -> Unit
) {
    if (show.value) {
        if (!xdialogStates.contains(show)) xdialogStates.add(show)
        LaunchedEffect(show.value) {
            if (show.value) {
                xdialogStates.forEach { state -> if (state != show) state.value = false }
            }
        }
 ...
 */
val xdialogStates = mutableStateListOf<MutableState<Boolean>>()
