...
data class HsvColor(
    ...
    fun toHex(): String {
        val color = toColor()
        val alpha = "%02X".format((color.alpha * 255f).toInt())
        val red = "%02X".format((color.red * 255f).toInt())
        val green = "%02X".format((color.green * 255f).toInt())
        val blue = "%02X".format((color.blue * 255f).toInt())
