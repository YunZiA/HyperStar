...
//    }
//
//    public void showRuntimeShader(Context context, float height2,float width,boolean mode) {
...
//        float height3 = height / height2;
//        if (width <= height) {
//            this.bound = new float[]{0.0f, 1.0f - height3, 1.0f, height3};
//        } else {
//            this.bound = new float[]{((width - height) / 2.0f) / width, 1.0f - height3, height / width, height3};
//        }
//    }
//}
