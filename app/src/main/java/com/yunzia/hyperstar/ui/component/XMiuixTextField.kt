...
fun XMiuixTextField(
    ...
    val border = Modifier.border(borderWidth, borderColor, RoundedRectangle(cornerRadius))
...
fun MTextField(
    ...
    val border = Modifier.border(borderWidth, backgroundColor, RoundedRectangle(cornerRadius))
