package com.yunzia.hyperstar.hook.app.systemui.controlcenter
...
class QSHeaderView : BaseHooker() {
    ...
    private fun startMethodsHook() {
        ...
        val ControlCenterHeaderController = XposedHelpers.findClass("com.android.systemui.controlcenter.shade.ControlCenterHeaderController",classLoader)
